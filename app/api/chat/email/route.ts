    ...
    if (body.type === "REPLY_NOTIFICATION") {
      ...
      const htmlReply = `
        <div style="${mainContainer}">
          ...
          <div style="${bodyStyle}">
            ...
            <a href="https://anduril.web.id/chat" style="${buttonStyle}">Buka Chat Room</a>
          </div>
          <div style="${footerStyle}">
            Sent by Anduril Ahmad Portfolio System • www.anduril.web.id • Madiun, Indonesia
          </div>
        </div>
      `;

      await transporter.sendMail({
        from: `"Anduril Ahmad" <${process.env.NODEMAILER_EMAIL}>`,
        to: targetEmail,
      ...
      const htmlNewChat = `
        <div style="${mainContainer}">
          ...
          <div style="${bodyStyle}">
            <p style="font-size: 16px; margin-top: 0;">Hi Anduril,</p>
            ...
            <a href="https://anduril.web.id/chat" style="${buttonStyle}">Balas Sekarang</a>
          </div>
          <div style="${footerStyle}">
