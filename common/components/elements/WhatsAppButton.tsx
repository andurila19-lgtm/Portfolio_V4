  ...
  if (floating) {
    return (
      <motion.a
        ...
        className="fixed bottom-20 right-6 z-50 flex items-center gap-2 cursor-pointer rounded-full bg-emerald-500 p-3.5 text-white shadow-xl transition-all duration-300 hover:scale-110 hover:bg-emerald-600 dark:bg-emerald-600 dark:hover:bg-emerald-500"
